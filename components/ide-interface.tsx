              ...
              <div className="border-t border-gray-200 px-4 py-2 flex items-center justify-between bg-white">
                <div className="flex items-center gap-2">
                  <div className="relative" ref={dropdownRef}>
                    ...
                    >
                      <span>
                        {isLoadingModels ? 'Carregando...' : getDisplayName(selectedModel) ? getDisplayName(selectedModel) : enabledModels.length > 0 ? 'Select Model' : 'No Models Enabled'} 
                      </span>
                        ...
                        <div className="p-1.5">
                          ...
                          {enabledModels.length === 0 && !isLoadingModels && (
                            <div className="px-3 py-2 text-sm text-gray-500 text-center">
                              Sem modelos configurados. Vá para Configurações &gt; Modelos.
                            </div>
                          )}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start" className="w-48">
                      ...
                      >
                        ...
                        <span className="flex-grow">Editar contexto</span> {/* Added flex-grow */} 
